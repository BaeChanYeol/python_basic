...
file_path = r'C:\Users\USER\Desktop\chanyeol\Java_Web_BCY\python\crawling\알라딘 베스트셀러 1~400위(뉴 버전)_{d.year}_{d.month}_{d.day}.xlsx'
...
# 브라우저 설정 - 일반 모드
browser = webdriver.Chrome(r'C:\Users\USER\Desktop\chanyeol\Java_Web_BCY\python\crawling\chromedriver.exe')
...
while True:
    ...
    for div_ss_book_box in div_ss_book_box_list:
        ...
        try:
            ...
            # 파이썬에서는 블록 구조에 아무것도 쓰지 않으면 에러입니다.
            # 블록 구조 내부에 딱히 작성할 코드가 없어서 넘길 떄
            # pass라는 키워드를 사용합니다.
            pass
        # 엑셀에 나머지 텍스트 저장
